...
AUR_PACKAGES = [
    ...
    Package("spotiflac-bin", "SpotiFLAC", "Get Spotify tracks in true FLAC from Tidal, Qobuz & Amazon Music", "audio-x-generic", "Media", "aur", domain="github.com"),
]
...
PACMAN_PACKAGES = [
    ...
    Package("bazaar", "Bazaar", "Modern app store for GNOME, focused on Flatpaks", "system-software-install", "System", "pacman", domain="apps.gnome.org"),
...
FLATPAK_PACKAGES = [
    ...
    Package("cine", "Cine", "Video player with a clean interface and MPV-based engine", "io.github.diegopvlk.Cine", "Media", "flatpak", domain="github.com",
            flatpak_id="io.github.diegopvlk.Cine"),
